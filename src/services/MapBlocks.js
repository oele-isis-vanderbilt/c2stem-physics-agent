    ...
    blocks = {
      ...
      */
      ...
      changeVelocity: {
        ...
        type: "command",
        category: "simulation",
        spec: "change velocity by x: %n y: %n",
        defaults: [0, 0],
        concepts: ["x_velocity", "y_velocity"],
      },
      changeXVelocity: {
      ...
      setAcceleration: {
        ...
        type: "command",
        category: "simulation",
        spec: "set acceleration to x: %n y: %n",
        defaults: [0, 0],
