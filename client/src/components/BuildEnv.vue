<template>
  <iframe
    src="https://physics.c2stem.org/?action=present&Username=oele&ProjectName=Drone_Model_two_packages_empty_HIDDEN_BLOCKS&noExitWarning&noRun&editMode&noExitWarning"
    id="iframe-id"
